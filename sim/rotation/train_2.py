...
from env_mujoco_2 import SimplePathFollowingEnv
...
def main():
    ...
    # copy this training script
    shutil.copy(__file__, os.path.join(run_dir, "train_2.py"))
    # copy the env file (locate via the class object)
    env_src = inspect.getsourcefile(SimplePathFollowingEnv)
    shutil.copy(env_src, os.path.join(run_dir, "env_mujoco_2.py"))
